...
//                7500, 6250, 5000, 0);
    ...
    private void assertCalculatePayment(int partyId, int largeMembersNum, int mediumMembersNum, int smallMembersNum, int billingAmount,
                                        int expectedPaymentOfMediumMember, int expectedPaymentOfLargeMember, int expectedPaymentOfSmallMember, int expectedBalanceDue) {
        ...
        assertEquals(expectedPaymentOfMediumMember, paymentModel.getPaymentOfLargeMember());
        assertEquals(expectedPaymentOfLargeMember, paymentModel.getPaymentOfMediumMember());
